...
float coopGutShot = gestalt.getConfig("gut.shot.multiplier", Float.class, Tags.of("mode", "coop"));  // 1.0
...
float pvpMaxPlayers = gestalt.getConfig("max.online.players", Float.class, Tags.of("mode", "pvp"));  // 32
float pveMaxPlayers = gestalt.getConfig("max.online.players", Float.class, Tags.of("mode", "pve"));  // not found
float coopMaxPlayers = gestalt.getConfig("max.online.players", Float.class, Tags.of("mode", "coop"));  // not found
float defaultMaxPlayers = gestalt.getConfig("max.online.players", Float.class);  // not found
```
