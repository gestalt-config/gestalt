...
- **Well Tested:** Our codebase boasts an impressive ~92% code coverage, validated by over 2000+ meaningful tests.
...
| dotenv       | 210      | values in a .env file are injected into your string. Configure the dotenv by registering a DotenvModuleConfig with ```.addModuleConfig(new DotenvModuleConfig(dotenv))```                                                                                                                                                                                                                                                                                                                                     || sys          | 200      | Java System Properties                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| JsonLoader            | json                                    | Leverages Jackson to load json files and convert them into a ConfigNode tree.                                                                                                                                                                                                                                                                                                                                                                       | [`gestalt-json`](https://search.maven.org/search?q=gestalt-json) For Jackson 3 use the module gestalt-json-jackson3, do not include both as they will conflict.  |
| TomlLoader            | toml                                    | Leverages Jackson to load toml files and convert them into a ConfigNode tree.                                                                                                                                                                                                                                                                                                                                                                       | [`gestalt-toml`](https://search.maven.org/search?q=gestalt-toml) For Jackson 3 use the module gestalt-toml-jackson3, do not include both as they will conflict.  |
| YamlLoader            | yml and yaml                            | Leverages Jackson to load yaml files and convert them into a ConfigNode tree.                                                                                                                                                                                                                                                                                                                                                                       | [`gestalt-yaml`](https://search.maven.org/search?q=gestalt-yaml) For Jackson 3 use the module gestalt-yaml-jackson3, do not include both as they will conflict.  |
...
```
## Jackson 3 support
Jackson 3 is supported as part of a new dependency `gestalt-json-jackson3`, `gestalt-toml-jackson3`, and `gestalt-yaml-jackson3`. Do not include both the jackson 2 and jackson 3 dependencies as they will conflict. If you are using the jackson 3 versions of the loaders, you can also customize them by registering the Module Configs with the builder.
