...
| proxyDecoderMode              | CACHE    | Either CACHE or PASSTHROUGH, where cache means we serve results through a cahce that is never updated or pass through where each call is forwared to Gestalt to be looked up.                                                                                                                                    |
