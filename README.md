...
| awsSecret    | n/a/     | An AWS Secret is injected for the secret name and key. Configure the AWS Secret by registering a AWSModuleConfig using the AWSBuilder. |
| gcpSecret    | n/a      | A Google Cloud Secret given the key provided. Configure the GCP Secret by registering an GoogleModuleConfig using the GoogleBuilder.   |
