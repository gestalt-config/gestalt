...
| dotenv       | 210      | values in a .env file are injected into your string. Configure the dotenv by registering a DotenvModuleConfig with ```.addModuleConfig(new DotenvModuleConfig(dotenv))```                                                                                                                                                                                                                                                                          |
