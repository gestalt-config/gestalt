...
public class K8ConfigNodeFactoryTest {
    ...
    public void testSupportsType() {
        Assertions.assertTrue(factory.supportsType("k8Secret"));
    ...
    public void testBuildWithValidPath() throws GestaltException {
        ...
        params.put("path", file.getParent());
    ...
    public void testBuildWithValidFile() throws GestaltException {
        ...
        Map<String, String> params = new HashMap<>();
        params.put("file", file.getParent());
    ...
    public void testBuildWithUnknownParameter() throws GestaltException {
        ...
        Assertions.assertEquals("Unknown Config Source Factory parameter for: k8Secret Parameter key: unknown, value: value",
