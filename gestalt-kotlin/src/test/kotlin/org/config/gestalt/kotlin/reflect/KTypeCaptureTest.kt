...
internal class KTypeCaptureTest {
    ...
    fun getKlass2() {
        ...
        assertEquals("org.config.gestalt.kotlin.reflect.KTypeCaptureTest\$DataClass", type.name)
        assertFalse(type.isAssignableFrom(Int::class.java))
        assertFalse(type.isAssignableFrom(Double::class.java))
    ...
    fun isAssignableFromHolder() {
        ...
        assertEquals(
            "org.config.gestalt.kotlin.reflect.KTypeCaptureTest\$Holder<java.lang.Integer>",
            type.name
        )
    ...
    fun isAssignableFromBaseClass() {
        ...
        assertEquals("org.config.gestalt.kotlin.reflect.KTypeCaptureTest\$BaseClass", type.name)
    ...
    fun isAssignableFromInheritedClass() {
        ...
        //assertEquals(java.lang.Integer::class, type.firstParameterType.type)
        assertEquals("org.config.gestalt.kotlin.reflect.KTypeCaptureTest\$InheritedClass", type.name)
