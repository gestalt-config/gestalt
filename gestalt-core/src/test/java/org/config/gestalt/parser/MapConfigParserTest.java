...
class MapConfigParserTest {
    ...
    public void testBuildConfigTree() {
        ...
        ValidateOf<ConfigNode> validateOfResults = mapConfigParser.parse(test);
    ...
    public void testValidateNullTokens() {
        ...
        ValidateOf<ConfigNode> validateOfResults = mapConfigParser.buildConfigTree(null, 0);
    ...
    public void testValidateMismatchedPathLength() {
        ...
        assertEquals(1, results.size());
        assertEquals(ValidationLevel.ERROR, results.get(0).level());
        assertEquals("Mismatched path lengths received for path: db.hosts", results.get(0).description());
    }
    ...
    public void testValidateMismatchedPathLength2() {
        ...
        assertEquals(1, results.size());
        assertEquals(ValidationLevel.ERROR, results.get(0).level());
        assertEquals("Mismatched path lengths received for path: db", results.get(0).description());
    }
